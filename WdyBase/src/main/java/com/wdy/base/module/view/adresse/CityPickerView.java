...
public class CityPickerView extends RelativeLayout implements View.OnClickListener{
    ...
    private void init(Context context) {
        ...
        mAdapter = new CityPickerView.AddressAdapter();
...
//    }
    ...
    private void sure() {
        if (mSelectProvice != null && mSelectCity != null ) {
            ...
            if (mOnAddressPickerSureListener != null) {
                mOnAddressPickerSureListener.onSureClick(mSelectProvice.getName() + " " + mSelectCity.getName() + " ",
                        mSelectProvice.getId(), mSelectCity.getId());
            }
        } else {
    ...
    class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.ViewHolder> {
        ...
        public AddressAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new AddressAdapter.ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_address_text, parent, false));
        }
